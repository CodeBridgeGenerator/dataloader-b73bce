...
import SingleVehiclesPage from "../components/VehiclesPage/SingleVehiclesPage";
import VehicleProjectLayoutPage from "../components/VehiclesPage/VehicleProjectLayoutPage";
import SingleLoyaltyprogramsPage from "../components/LoyaltyprogramsPage/SingleLoyaltyprogramsPage";
import LoyaltyprogramProjectLayoutPage from "../components/LoyaltyprogramsPage/LoyaltyprogramProjectLayoutPage";
...
import SingleServicesPage from "../components/ServicesPage/SingleServicesPage";
import ServiceProjectLayoutPage from "../components/ServicesPage/ServiceProjectLayoutPage";
import SingleServicerecordsPage from "../components/ServicerecordsPage/SingleServicerecordsPage";
import ServicerecordProjectLayoutPage from "../components/ServicerecordsPage/ServicerecordProjectLayoutPage";
import SingleMaintenanceschedulesPage from "../components/MaintenanceschedulesPage/SingleMaintenanceschedulesPage";
import MaintenancescheduleProjectLayoutPage from "../components/MaintenanceschedulesPage/MaintenancescheduleProjectLayoutPage";
import SingleOilchangerecordsPage from "../components/OilchangerecordsPage/SingleOilchangerecordsPage";
import OilchangerecordProjectLayoutPage from "../components/OilchangerecordsPage/OilchangerecordProjectLayoutPage";
import SingleTechniciansPage from "../components/TechniciansPage/SingleTechniciansPage";
import TechnicianProjectLayoutPage from "../components/TechniciansPage/TechnicianProjectLayoutPage";
import SinglePartsinventoryPage from "../components/PartsinventoryPage/SinglePartsinventoryPage";
import PartsinventoryProjectLayoutPage from "../components/PartsinventoryPage/PartsinventoryProjectLayoutPage";
import SingleSuppliersPage from "../components/SuppliersPage/SingleSuppliersPage";
import SupplierProjectLayoutPage from "../components/SuppliersPage/SupplierProjectLayoutPage";
