...
supplierid: _entity?.supplierid,
    ...
    return (
        <Dialog header="Edit Partsinventory" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
