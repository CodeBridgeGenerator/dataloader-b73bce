...
const p_dateTemplate5 = (rowData, { rowIndex }) => <p >{(new Date(rowData.joindate)).toLocaleDateString()}</p>
const p_dateTemplate6 = (rowData, { rowIndex }) => <p >{(new Date(rowData.loyaltypoints)).toLocaleDateString()}</p>
...
<Column field="joindate" header="Joindate" body={p_dateTemplate5} filter={selectedFilterFields.includes("joindate")} hidden={selectedHideFields?.includes("joindate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="loyaltypoints" header="Loyaltypoints" body={p_dateTemplate6} filter={selectedFilterFields.includes("loyaltypoints")} hidden={selectedHideFields?.includes("loyaltypoints")}  sortable style={{ minWidth: "8rem" }} />
