...
const TechniciansPage = (props) => {
    ...
    const service = _.find(config.services, { serviceName : "technicians"});
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">Technicians </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                    <Button label="add" loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="technicians-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="technicians-datatable">
...
/>
            ...
            <TechniciansCreateDialogComponent entity={newRecord} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
