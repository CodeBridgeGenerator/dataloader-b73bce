...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Phonenumber</label><p className="m-0 ml-3" >{_entity?.phonenumber}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Specialization</label><p className="m-0 ml-3" >{_entity?.specialization}</p></div>
