...
const SingleInvoicesPage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Paymentstatus</label><p className="m-0 ml-3" >{_entity?.paymentstatus}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Paymentmethod</label><p className="m-0 ml-3" >{_entity?.paymentmethod}</p></div>
